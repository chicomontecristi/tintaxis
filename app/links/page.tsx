...
// ─── LINK IN BIO ─────────────────────────────────────────────────────────────
// The page you put in your Instagram bio, Twitter bio, gallery cards, etc.
// Designed to be fast, mobile-first, and visually consistent with Tintaxis.
// Each link opens in a new context — the reader decides where to go.
          ...
          return (
            <Tag
              ...
              style={{
                display: "block",
                padding: "14px 18px",
                border: `1px solid rgba(${link.accent}, 0.2)`,
                borderRadius: "3px",
                background: `rgba(${link.accent}, 0.04)`,
                textDecoration: "none",
                transition: "border-color 0.18s ease, background 0.18s ease",
              }}
              onMouseEnter={(e: React.MouseEvent<HTMLElement>) => {
                (e.currentTarget as HTMLElement).style.borderColor = `rgba(${link.accent}, 0.45)`;
                (e.currentTarget as HTMLElement).style.background = `rgba(${link.accent}, 0.08)`;
              }}
              onMouseLeave={(e: React.MouseEvent<HTMLElement>) => {
                (e.currentTarget as HTMLElement).style.borderColor = `rgba(${link.accent}, 0.2)`;
                (e.currentTarget as HTMLElement).style.background = `rgba(${link.accent}, 0.04)`;
              }}
            >
              <p
                style={{
